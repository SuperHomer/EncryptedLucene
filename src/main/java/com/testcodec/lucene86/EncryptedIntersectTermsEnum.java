...
public class EncryptedIntersectTermsEnum extends BaseTermsEnum {
    ...
    public EncryptedIntersectTermsEnum(EncryptedFieldReader fr, Automaton automaton, RunAutomaton runAutomaton, BytesRef commonSuffix, BytesRef startTerm) throws IOException {
        this.fr = fr;
        ...
        while (currentFrame.nextEnt == currentFrame.entCount) {
            if (!currentFrame.isLastInFloor) {
                ...
                if (currentFrame.ord == 0) {
                    throw EncryptedIntersectTermsEnum.NoMoreTermsException.INSTANCE;
                }
    ...
    private static final class NoMoreTermsException extends RuntimeException {
        ...
        // Only used internally when there are no more terms in next():
        public static final EncryptedIntersectTermsEnum.NoMoreTermsException INSTANCE = new EncryptedIntersectTermsEnum.NoMoreTermsException();
    ...
    public BytesRef next() throws IOException {
        try {
            return _next();
        } catch (EncryptedIntersectTermsEnum.NoMoreTermsException eoi) {
