...
public class EncryptedSegmentTermsEnum extends BaseTermsEnum  {
    // Lazy init:
    IndexInput in;
    ...
    public EncryptedStats computeBlockStats() throws IOException {

        EncryptedStats stats = new EncryptedStats(fr.parent.segment, fr.fieldInfo.name);
        if (fr.index != null) {
