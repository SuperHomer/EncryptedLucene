...
public class EncryptedBlockTreeTermsReader extends FieldsProducer {
    ...
    private final Map<String,EncryptedFieldReader> fieldMap;
    ...
    /** Sole constructor. */
    public EncryptedBlockTreeTermsReader(PostingsReaderBase postingsReader, SegmentReadState state) throws IOException {
        ...
        try {
            ...
            Map<String, EncryptedFieldReader> fieldMap = null;
            ...
            try (ChecksumIndexInput metaIn = version >= VERSION_META_FILE ? state.directory.openChecksumInput(metaName, state.context) : null) {
                try {
                    ...
                    for (int i = 0; i < numFields; ++i) {
                        ...
                        EncryptedFieldReader previous = fieldMap.put(fieldInfo.name,
                                new EncryptedFieldReader(this, fieldInfo, numTerms, rootCode, sumTotalTermFreq, sumDocFreq, docCount,
    ...
    public long ramBytesUsed() {
        ...
        for(EncryptedFieldReader reader : fieldMap.values()) {
