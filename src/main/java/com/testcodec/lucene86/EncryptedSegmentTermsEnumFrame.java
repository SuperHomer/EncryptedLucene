...
public class EncryptedSegmentTermsEnumFrame {
    // Our index in stack[]:
    final int ord;
    ...
    public EncryptedSegmentTermsEnumFrame(EncryptedSegmentTermsEnum ste, int ord) throws IOException {
        ...
        if (version >= EncryptedBlockTreeTermsReader.VERSION_COMPRESSED_SUFFIXES) {
    ...
    void loadBlock() throws IOException {
        ...
        if (version >= EncryptedBlockTreeTermsReader.VERSION_COMPRESSED_SUFFIXES) {
            ...
            try {
                compressionAlg = EncryptedBlockTreeTermsWriter.CompressionAlgorithm.byCode((int) codeL & 0x03);
    ...
    */
    ...
    EncryptedBlockTreeTermsWriter.CompressionAlgorithm compressionAlg = EncryptedBlockTreeTermsWriter.CompressionAlgorithm.NO_COMPRESSION;
