...
public class EncryptedFieldReader extends Terms implements Accountable {
    ...
    EncryptedFieldReader(EncryptedBlockTreeTermsReader parent, FieldInfo fieldInfo, long numTerms, BytesRef rootCode, long sumTotalTermFreq, long sumDocFreq, int docCount,
    ...
    @Override
    public EncryptedStats getStats() throws IOException {
    ...
    public TermsEnum intersect(CompiledAutomaton compiled, BytesRef startTerm) throws IOException {
        ...
        return new EncryptedIntersectTermsEnum(this, compiled.automaton, compiled.runAutomaton, compiled.commonSuffixRef, startTerm);
    }
